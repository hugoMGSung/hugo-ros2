...
Ubuntu의 웹 브라우저 기본은 [Firefox](https://www.firefox.com/ko/) 입니다. 파이어폭스가 성능에 문제가 있지는 않으나 가장 잘 알려진 크롬 브라우저가 일반적일 것입니다. 그래서 크롬 브라우저를 설치합니다.

Firefox 브라우저에서 chrome 을 검색합니다. [여기](https://support.google.com/chrome/answer/95346?hl=ko&co=GENIE.Platform%3DDesktop#zippy=%2Clinux) 에서 찾으면 됩니다.

![](assets/20260723_200137_image.png)

![](assets/20260723_200207_image.png)

복잡하게 명령어로 설치할 필요 없습니다.

![](assets/20260723_200326_image.png)

**Open With Other Application** 을 선택한 뒤 **Software install**을 선택합니다.

![](assets/20260723_200516_image.png)

위를 확인하고 **Install**을 클릭하면 됩니다. 설치는 금방 완료됩니다. 앱에서 Chrome을 검색하고 선택하면,

![](assets/20260723_200727_image.png)

위와 같은 알림창이 뜨고 OK를 누르면 브라우저가 실행됩니다.
...
Ubuntu에는 Python이 설치되어 있습니다. 하지만, Python을 사용하려면 Python3 라는 명령어로 진행해야 합니다. 이는 매우 불편해서 여타 OS에서 사용하는 것과 같이 Python으로 명령어를 통일합니다.
